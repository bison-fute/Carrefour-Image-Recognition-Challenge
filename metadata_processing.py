...
class ExploratoryDataAnalysis():
    ...
    def merge_cat_for_min_size(self, min_cat_size, level=1):
        """
        Recursive function that merges categories as long as they do not gather
        at least min_cat_size
        """
    ...
    def normalize_cat_ids(self):
        """
        Change les ids des catégories pour les mettre entre 0 et cat_max. Met aussi à jour
        les dictionnaires cat_to_name et cat_to_quant
        """
        new_cat_to_name = {}
        new_barcode_to_cat = {}
        cat_to_new_cat = {}
        ...
        self.update_cat_to_quant()
        print("On obtient finalement %d catégories différentes"
...
# Todo : créeer un dict cat -> newCat (entre 0 et CatMax); et newCat -> CatName
